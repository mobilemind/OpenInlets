...
+ [OpenInFirefox-Focus] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))%7Blocation.href=%22firefox-focus://open-url?url=%22+encodeURIComponent(location.href)+%22&private=true%22%7Dvoid'1.0.0'``
+ [OpenInFirefox-Private] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))%7Blocation.href=%22firefox://open-url?url=%22+encodeURIComponent(location.href)+%22&private=true%22%7Dvoid'1.0.0'``
...
[OpenInFirefox-Focus]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))%7Blocation.href=%22firefox-focus://open-url?url=%22+encodeURIComponent(location.href)+%22&amp;private=true%22%7Dvoid'1.0.0' "OpenInFirefox-Focus"
[OpenInFirefox-Private]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))%7Blocation.href=%22firefox://open-url?url=%22+encodeURIComponent(location.href)+%22&amp;private=true%22%7Dvoid'1.0.0' "OpenInFirefox-Private"
...
[Setup OpenInFirefox-Focus]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))%7Blocation.href%3D%22firefox-focus%3A%2F%2Fopen-url%3Furl%3D%22%2BencodeURIComponent(location.href)%2B%22%26private%3Dtrue%22%7Dvoid'1.0.0' "Setup OpenInFirefox-Focus"
[Setup OpenInFirefox-Private]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))%7Blocation.href%3D%22firefox%3A%2F%2Fopen-url%3Furl%3D%22%2BencodeURIComponent(location.href)%2B%22%26private%3Dtrue%22%7Dvoid'1.0.0' "Setup OpenInFirefox-Private"
