...
+ [ModifySupportUrl] v1.2.0 ``javascript:var%20i=document.location%3Bif('support.apple.com'===i.host){const%20p=/(%5C/guide%5C/%5B-0-9a-z%5D+%5C/)(%5B-0-9a-z%5D+)%5C//%2Cl=RegExp('/'+navigator.language.toLowerCase()+'/'%2C'i')%2Cr=i.pathname%2Cs=window.getSelection()%2Cd=i.href%3Blet%20e=''%2Ct=document.title.replace(/%20-%20(Official%20)?Apple%20Support%24/%2C'')%2Cn=null%2Co=d%2Ca=''%3Bif(l.test(r))o=d.replace(l%2C'/')%3Belse%20if(!/-/.test(r)%26%26p.test(r)){let%20e=d.indexOf('/toc/')%3B0%3Ce?o=d.substr(0%2Ce+5):0%3C(e=d.indexOf('/welcome/'))%26%26(o=d.substr(0%2Ce+9))}else{if(null!==(n=r.match(p))%26%261%3Cn.length){const%20c=n%5B2%5D.split('-')%3Bo='https://support.apple.com'+n%5B1%5D+c.pop()+'/'}'None'!==s.type%26%260%3Cs.rangeCount%26%26((i=s.getRangeAt(0))%26%26(i=3===(i=i.startContainer).nodeType?i.parentNode:i).parentNode%26%26(a=i.parentNode.id%2C''!==(e=i.innerText)%26%26''!==a%26%26(t=e%2Co+='%23'+a))%2Cs.empty())}alert(%60Original%20URL-%0A%24{d}%0A%0AModified%20URL-%0A%24{o}%24{''!==e%26%26''!==a?'%5Cn%5CnSelected%20Heading-%5Cn'+e:''}%0A%0AMarkdown%20link-%0A%5B%24{t}%5D(%24{o})%60)}void%200%3Bvoid'1.2.0'``
...
+ __Mobile Safari setup link__ -- [Setup ModifySupportUrl] v1.2.0
...
[ModifySupportUrl]: javascript:var%20i=document.location%3Bif('support.apple.com'===i.host){const%20p=/(%5C/guide%5C/%5B-0-9a-z%5D+%5C/)(%5B-0-9a-z%5D+)%5C//%2Cl=RegExp('/'+navigator.language.toLowerCase()+'/'%2C'i')%2Cr=i.pathname%2Cs=window.getSelection()%2Cd=i.href%3Blet%20e=''%2Ct=document.title.replace(/%20-%20(Official%20)?Apple%20Support%24/%2C'')%2Cn=null%2Co=d%2Ca=''%3Bif(l.test(r))o=d.replace(l%2C'/')%3Belse%20if(!/-/.test(r)%26%26p.test(r)){let%20e=d.indexOf('/toc/')%3B0%3Ce?o=d.substr(0%2Ce+5):0%3C(e=d.indexOf('/welcome/'))%26%26(o=d.substr(0%2Ce+9))}else{if(null!==(n=r.match(p))%26%261%3Cn.length){const%20c=n%5B2%5D.split('-')%3Bo='https://support.apple.com'+n%5B1%5D+c.pop()+'/'}'None'!==s.type%26%260%3Cs.rangeCount%26%26((i=s.getRangeAt(0))%26%26(i=3===(i=i.startContainer).nodeType?i.parentNode:i).parentNode%26%26(a=i.parentNode.id%2C''!==(e=i.innerText)%26%26''!==a%26%26(t=e%2Co+='%23'+a))%2Cs.empty())}alert(%60Original%20URL-%0A%24{d}%0A%0AModified%20URL-%0A%24{o}%24{''!==e%26%26''!==a?'%5Cn%5CnSelected%20Heading-%5Cn'+e:''}%0A%0AMarkdown%20link-%0A%5B%24{t}%5D(%24{o})%60)}void%200%3Bvoid'1.2.0' "ModifySupportUrl"
...
[Setup ModifySupportUrl]: https://mobilemind.github.io/OpenInlets/x/#javascript:var%20i=document.location%3Bif('support.apple.com'===i.host){const%20p=/(%5C/guide%5C/%5B-0-9a-z%5D+%5C/)(%5B-0-9a-z%5D+)%5C//%2Cl=RegExp('/'+navigator.language.toLowerCase()+'/'%2C'i')%2Cr=i.pathname%2Cs=window.getSelection()%2Cd=i.href%3Blet%20e=''%2Ct=document.title.replace(/%20-%20(Official%20)?Apple%20Support%24/%2C'')%2Cn=null%2Co=d%2Ca=''%3Bif(l.test(r))o=d.replace(l%2C'/')%3Belse%20if(!/-/.test(r)%26%26p.test(r)){let%20e=d.indexOf('/toc/')%3B0%3Ce?o=d.substr(0%2Ce+5):0%3C(e=d.indexOf('/welcome/'))%26%26(o=d.substr(0%2Ce+9))}else{if(null!==(n=r.match(p))%26%261%3Cn.length){const%20c=n%5B2%5D.split('-')%3Bo='https://support.apple.com'+n%5B1%5D+c.pop()+'/'}'None'!==s.type%26%260%3Cs.rangeCount%26%26((i=s.getRangeAt(0))%26%26(i=3===(i=i.startContainer).nodeType?i.parentNode:i).parentNode%26%26(a=i.parentNode.id%2C''!==(e=i.innerText)%26%26''!==a%26%26(t=e%2Co+='%23'+a))%2Cs.empty())}alert(%60Original%20URL-%0A%24{d}%0A%0AModified%20URL-%0A%24{o}%24{''!==e%26%26''!==a?'%5Cn%5CnSelected%20Heading-%5Cn'+e:''}%0A%0AMarkdown%20link-%0A%5B%24{t}%5D(%24{o})%60)}void%200%3Bvoid'1.2.0' "Setup ModifySupportUrl"
