...
+ [KillStickyHeaders] v1.2.0 ``javascript:(()=%3E%7Blet%20e=document.querySelectorAll('body%20*'),o=0;for(o=0;o%3Ce.length;o++)'fixed'===getComputedStyle(e%5Bo%5D).position&&e%5Bo%5D.parentNode.removeChild(e%5Bo%5D)%7D)();void'1.2.0'``
+ [OpenIn1Password] v1.5.1 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='op'+location.href;void'1.5.1'``
+ [OpenInBrave] v1.0.1 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='brave://open-url?url='+encodeURIComponent(location.href);void'1.0.1'``
+ [OpenInCodeBucket] v1.3.1 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&&'bitbucket.org'===location.host)location.href='codebucket://'+location.href.split('/').slice(2,5).join('/');void'1.3.1'``
+ [OpenInCodeHub] v1.3.1 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&&'github.com'===location.host)location.href='codehub://'+location.href.split('/').slice(2,5).join('/');void'1.3.1'``
+ [OpenInDolphin] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace(/%5Ehttps?/,'dolphin');void'1.0.0'``
+ [OpenInFirefox] v1.5.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='firefox://open-url?url='+encodeURIComponent(location.href);void'1.5.0'``
+ [OpenInFirefox-Focus] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='firefox-focus://open-url?url='+encodeURIComponent(location.href)+'&private=true';void'1.0.0'``
+ [OpenInFirefox-Private] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='firefox://open-url?url='+encodeURIComponent(location.href)+'&private=true';void'1.0.0'``
+ [OpenInGoodReader] v1.5.1 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&&/%5C.pdf($%7C%5C?)/.test(location.href))location.href='gr'+location.href;void'1.5.1'``
+ [OpenInGoogleChrome] v1.4.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace(/%5Ehttp/,'googlechrome');void'1.4.0'``
+ [OpenInGoogleMaps] v2.2.0 ``javascript:if(/%5C.google%5C.com/.test(location.host)&&/iP(.d%7Chone)/.test(navigator.userAgent))%7Bif(location.search)return%20location.href='comgooglemaps://'+location.search;if(/%20-%20Google%20Maps/.test(document.title))location.href='comgooglemaps://?q='+encodeURI(document.title.replace('%20-%20Google%20Maps','').replace(/%20/g,'+'))%7Dvoid'2.2.0'``
+ [OpenInOpera] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='opera://open-url?url='+encodeURIComponent(location.href);void'1.0.0'``
+ [OpenInTextastic] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace(/%5Ehttps?/,'textastic');void'1.0.0'``
+ [OpenIniOctocat] v1.6.0 ``javascript:if(/(gist%5C.)?github%5C.com/.test(location.host)&&/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace('https:','ioc:');void'1.6.0'``
+ [OpenInWorkingCopy] v1.5.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&&('bitbucket.org'===location.host%7C%7C'github.com'===location.host))location.href='working-copy://show?remote='+encodeURIComponent(location.href.split('/').slice(0,5).join('/'))+'.git';void'1.5.0'``
...
<!-- not embedded
[LoginESA] v1.0.1 ``javascript:if('login.innflux.com'!==window.location.host)return%20window.location.href='https://login.innflux.com/';if(document.getElementById('sRoom'))return%20document.getElementById('sLastName').value='Name',document.getElementById('sRoom').value='000',document.getElementById('connect').click();if(document.getElementById('1'))document.getElementById('1').checked=!0,document.getElementsByName('TOS')%5B0%5D.checked=!0,document.getElementsByName('iStep')%5B0%5D.click(),document.getElementsByTagName('form')%5B0%5D.submit();void'1.0.1'``
-->
...
<!--
[LoginESA]: javascript:if('login.innflux.com'!==window.location.host)return%20window.location.href='https://login.innflux.com/';if(document.getElementById('sRoom'))return%20document.getElementById('sLastName').value='Name',document.getElementById('sRoom').value='000',document.getElementById('connect').click();if(document.getElementById('1'))document.getElementById('1').checked=!0,document.getElementsByName('TOS')%5B0%5D.checked=!0,document.getElementsByName('iStep')%5B0%5D.click(),document.getElementsByTagName('form')%5B0%5D.submit();void'1.0.1' "LoginESA"
-->
...
[OpenInCodeBucket]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&amp;&amp;'bitbucket.org'===location.host)location.href='codebucket://'+location.href.split('/').slice(2,5).join('/');void'1.3.1' "OpenInCodeBucket"
[OpenInCodeHub]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&amp;&amp;'github.com'===location.host)location.href='codehub://'+location.href.split('/').slice(2,5).join('/');void'1.3.1' "OpenInCodeHub"
[OpenInDolphin]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace(/%5Ehttps?/,'dolphin');void'1.0.0' "OpenInDolphin"
[OpenInFirefox]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='firefox://open-url?url='+encodeURIComponent(location.href);void'1.5.0' "OpenInFirefox"
[OpenInFirefox-Focus]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='firefox-focus://open-url?url='+encodeURIComponent(location.href)+'&amp;private=true';void'1.0.0' "OpenInFirefox-Focus"
[OpenInFirefox-Private]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='firefox://open-url?url='+encodeURIComponent(location.href)+'&amp;private=true';void'1.0.0' "OpenInFirefox-Private"
[OpenInGoodReader]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&amp;&amp;/%5C.pdf($%7C%5C?)/.test(location.href))location.href='gr'+location.href;void'1.5.1' "OpenInGoodReader"
[OpenInGoogleChrome]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace(/%5Ehttp/,'googlechrome');void'1.4.0' "OpenInGoogleChrome"
[OpenInGoogleMaps]: javascript:if(/%5C.google%5C.com/.test(location.host)&amp;&amp;/iP(.d%7Chone)/.test(navigator.userAgent))%7Bif(location.search)return%20location.href='comgooglemaps://'+location.search;if(/%20-%20Google%20Maps/.test(document.title))location.href='comgooglemaps://?q='+encodeURI(document.title.replace('%20-%20Google%20Maps','').replace(/%20/g,'+'))%7Dvoid'2.2.0' "OpenInGoogleMaps"
[OpenInOpera]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href='opera://open-url?url='+encodeURIComponent(location.href);void'1.0.0' "OpenInOpera"
[OpenInTextastic]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace(/%5Ehttps?/,'textastic');void'1.0.0' "OpenInTextastic"
[OpenIniOctocat]: javascript:if(/(gist%5C.)?github%5C.com/.test(location.host)&amp;&amp;/iP(.d%7Chone)/.test(navigator.userAgent))location.href=location.href.replace('https:','ioc:');void'1.6.0' "OpenIniOctocat"
[OpenInWorkingCopy]: javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent)&amp;&amp;('bitbucket.org'===location.host%7C%7C'github.com'===location.host))location.href='working-copy://show?remote='+encodeURIComponent(location.href.split('/').slice(0,5).join('/'))+'.git';void'1.5.0' "OpenInWorkingCopy"
...
[UtmStrip]: javascript:(()=%3E%7Bconst%20t=window.location.href,e=t.indexOf('?');if(t.indexOf('utm_')%3Ee)%7Blet%20n=t.replace(/(%5B?&amp;%5Dutm_(source%7Cmedium%7Cterm%7Ccampaign%7Ccontent)=%5B%5E&amp;#%5D+)/gi,'');'&amp;'===n.charAt(e)&amp;&amp;(n=n.substr(0,e)+'?'+n.substr(e+1)),n!==t&amp;&amp;history.replaceState(null,null,n)%7D%7D)();void'1.0.0' "UtmStrip"
<!--- Setup links -->
...
<!--
[Setup LoginESA]: http://mmind.me/_#javascript:if('login.innflux.com'!%3D%3Dwindow.location.host)return%20window.location.href%3D'https%3A%2F%2Flogin.innflux.com%2F'%3Bif(document.getElementById('sRoom'))return%20document.getElementById('sLastName').value%3D'Name'%2Cdocument.getElementById('sRoom').value%3D'000'%2Cdocument.getElementById('connect').click()%3Bif(document.getElementById('1'))document.getElementById('1').checked%3D!0%2Cdocument.getElementsByName('TOS')%5B0%5D.checked%3D!0%2Cdocument.getElementsByName('iStep')%5B0%5D.click()%2Cdocument.getElementsByTagName('form')%5B0%5D.submit()%3Bvoid'1.0.1' "Setup LoginESA"
-->
...
[Setup OpenInCodeBucket]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent)%26%26'bitbucket.org'%3D%3D%3Dlocation.host)location.href%3D'codebucket%3A%2F%2F'%2Blocation.href.split('%2F').slice(2%2C5).join('%2F')%3Bvoid'1.3.1' "Setup OpenInCodeBucket"
[Setup OpenInCodeHub]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent)%26%26'github.com'%3D%3D%3Dlocation.host)location.href%3D'codehub%3A%2F%2F'%2Blocation.href.split('%2F').slice(2%2C5).join('%2F')%3Bvoid'1.3.1' "Setup OpenInCodeHub"
[Setup OpenInDolphin]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3Dlocation.href.replace(%2F%5Ehttps%3F%2F%2C'dolphin')%3Bvoid'1.0.0' "Setup OpenInDolphin"
[Setup OpenInFirefox]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3D'firefox%3A%2F%2Fopen-url%3Furl%3D'%2BencodeURIComponent(location.href)%3Bvoid'1.5.0' "Setup OpenInFirefox"
[Setup OpenInFirefox-Focus]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3D'firefox-focus%3A%2F%2Fopen-url%3Furl%3D'%2BencodeURIComponent(location.href)%2B'%26private%3Dtrue'%3Bvoid'1.0.0' "Setup OpenInFirefox-Focus"
[Setup OpenInFirefox-Private]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3D'firefox%3A%2F%2Fopen-url%3Furl%3D'%2BencodeURIComponent(location.href)%2B'%26private%3Dtrue'%3Bvoid'1.0.0' "Setup OpenInFirefox-Private"
[Setup OpenInGoodReader]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent)%26%26%2F%5C.pdf(%24%7C%5C%3F)%2F.test(location.href))location.href%3D'gr'%2Blocation.href%3Bvoid'1.5.1' "Setup OpenInGoodReader"
[Setup OpenInGoogleChrome]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3Dlocation.href.replace(%2F%5Ehttp%2F%2C'googlechrome')%3Bvoid'1.4.0' "Setup OpenInGoogleChrome"
[Setup OpenInGoogleMaps]: http://mmind.me/_#javascript:if(%2F%5C.google%5C.com%2F.test(location.host)%26%26%2FiP(.d%7Chone)%2F.test(navigator.userAgent))%7Bif(location.search)return%20location.href%3D'comgooglemaps%3A%2F%2F'%2Blocation.search%3Bif(%2F%20-%20Google%20Maps%2F.test(document.title))location.href%3D'comgooglemaps%3A%2F%2F%3Fq%3D'%2BencodeURI(document.title.replace('%20-%20Google%20Maps'%2C'').replace(%2F%20%2Fg%2C'%2B'))%7Dvoid'2.2.0' "Setup OpenInGoogleMaps"
[Setup OpenInOpera]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3D'opera%3A%2F%2Fopen-url%3Furl%3D'%2BencodeURIComponent(location.href)%3Bvoid'1.0.0' "Setup OpenInOpera"
[Setup OpenInTextastic]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3Dlocation.href.replace(%2F%5Ehttps%3F%2F%2C'textastic')%3Bvoid'1.0.0' "Setup OpenInTextastic"
[Setup OpenIniOctocat]: http://mmind.me/_#javascript:if(%2F(gist%5C.)%3Fgithub%5C.com%2F.test(location.host)%26%26%2FiP(.d%7Chone)%2F.test(navigator.userAgent))location.href%3Dlocation.href.replace('https%3A'%2C'ioc%3A')%3Bvoid'1.6.0' "Setup OpenIniOctocat"
[Setup OpenInWorkingCopy]: http://mmind.me/_#javascript:if(%2FiP(.d%7Chone)%2F.test(navigator.userAgent)%26%26('bitbucket.org'%3D%3D%3Dlocation.host%7C%7C'github.com'%3D%3D%3Dlocation.host))location.href%3D'working-copy%3A%2F%2Fshow%3Fremote%3D'%2BencodeURIComponent(location.href.split('%2F').slice(0%2C5).join('%2F'))%2B'.git'%3Bvoid'1.5.0' "Setup OpenInWorkingCopy"
...
[Setup UtmStrip]: http://mmind.me/_#javascript:(()%3D%3E%7Bconst%20t%3Dwindow.location.href%2Ce%3Dt.indexOf('%3F')%3Bif(t.indexOf('utm_')%3Ee)%7Blet%20n%3Dt.replace(%2F(%5B%3F%26%5Dutm_(source%7Cmedium%7Cterm%7Ccampaign%7Ccontent)%3D%5B%5E%26%23%5D%2B)%2Fgi%2C'')%3B'%26'%3D%3D%3Dn.charAt(e)%26%26(n%3Dn.substr(0%2Ce)%2B'%3F'%2Bn.substr(e%2B1))%2Cn!%3D%3Dt%26%26history.replaceState(null%2Cnull%2Cn)%7D%7D)()%3Bvoid'1.0.0' "Setup UtmStrip"
<!-- Badge links -->
