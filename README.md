...
+ [OpenInFirefox] v1.0.0 ``javascript:if(/iP(.d%7Chone)/.test(navigator.userAgent))%7Blocation.href='firefox://open-url?url='+encodeURIComponent(location.href)+'&private=true'%7Dvoid'1.0.0'``
...
[Setup KillStickyHeaders]: http://mmind.me/x/#javascript:(()%3D%3E%7Blet%20e%3Ddocument.querySelectorAll('body%20*')%2Co%3D0%3Bfor(o%3D0%3Bo%3Ce.length%3Bo%2B%2B)%7Bif('fixed'%3D%3D%3DgetComputedStyle(e%5Bo%5D).position)%7Be%5Bo%5D.parentNode.removeChild(e%5Bo%5D)%7D%7D%7D)()%3Bvoid'1.2.0' "Setup KillStickyHeaders"
