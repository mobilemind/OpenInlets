...
[UtmStrip]: javascript:'use%20strict'%3B(()=%3E%7Bconst%20e=location.pathname%2Ct=location.search%3Bif(3%3Et.length%26%26!e.includes('%2Famp'))return%3Bconst%20r=location.hostname%2Co=new%20URLSearchParams(t)%2Ci=%5B'assetType'%2C'elqTrack'%2C'mkt%5Ftok'%2C'originalReferer'%2C'referrer'%2C'terminal%5Fid'%2C'trk'%2C'trkCampaign'%2C'trkInfo'%2C'anid'%2C'assetid'%2C'campaignid'%2C'eid'%2C'gclid'%2C'recipientid'%2C'siteid'%2C'fbclid'%2C'hrc'%2C'refsrc'%2C'gclsrc'%2C'%5Fhsenc'%2C'%5Fhsmi'%2C'mc%5Fcid'%2C'mc%5Feid'%2C'iesrc'%2C'cm%5Fmmc'%2C'cm%5Fre'%2C'cm%5Fsp'%2C'manual%5Fcm%5Fmmc'%5D%2Ca=%5B'fb%5F'%2C'action%5F'%2C'utm%5F'%2C'ga%5F'%2C'hmb%5F'%2C'pk%5F'%5D%2Cc=%5B'btsid'%2C'ws%5Fab%5Ftest'%2C'spm'%2C'scm'%2C'algo%5Fevid'%2C'algo%5Fpvid'%5D%2Cs=%5B'aff%5F'%5D%2Cn=%5B'%5Fencoding'%2C'ie'%2C'linkCode'%2C'linkId'%2C'pf'%2C'psc'%2C'ref%5F'%2C'tag'%2C'content-id'%2C'crid'%2C'cv%5Fct%5Fcx'%2C'language'%2C'qid'%2C'sprefix'%2C'sr'%2C'th'%2C'asc%5Fcampaign'%2C'asc%5Frefurl'%2C'asc%5Fsource'%2C'ascsubtag'%2C'dib'%2C'dib%5Ftag'%2C'pd%5Frd%5Fi'%2C'pd%5Frd%5Fr'%2C'pd%5Frd%5Fw'%2C'pd%5Frd%5Fwg'%2C'pf%5Frd%5Fi'%2C'pf%5Frd%5Fm'%2C'pf%5Frd%5Fp'%2C'pf%5Frd%5Fr'%2C'pf%5Frd%5Fs'%2C'pf%5Frd%5Ft'%5D%2C%5F=%5B'ac'%2C'annotation%5Fid'%2C'app'%2C'feature'%2C'gclid'%2C'kw'%2C'src%5Fvid'%5D%2Cd=r.includes('aliexpress.')%2Cm=%2F(%7C%5C.)amazon%5C.com%24%2F.test(r)%2Cp=%2F(m%7Cwww)%5C.youtube%5C.com%24%2F.test(r)%7C%7C'youtu.be'===r%7C%7C'www.youtube-nocookie.com'===r%2Cl=e=%3E%7Bconst%20t=e.toLowerCase()%3Bif(i.some(e=%3Ee.toLowerCase()===t))return!0%3Bif(a.some(e=%3Et.startsWith(e)))return!0%3Bif(%2F%5Ecm%5Fmmca%5Cd%2B%24%2Fi.test(e))return!0%3Bif(d)%7Bif(c.some(e=%3Ee.toLowerCase()===t))return!0%3Bif(s.some(e=%3Et.startsWith(e)))return!0%7Dreturn!(!m%7C%7C!n.some(e=%3Ee.toLowerCase()===t))%7C%7C!(!p%7C%7C!%5F.some(e=%3Ee.toLowerCase()===t))%7D%3Bfor(const%20e%20of%5B...o.keys()%5D)l(e)%26%26o.delete(e)%3Blet%20f=o.toString()%3Bf=f%3F'%3F'%2Bf:''%3Bconst%20u=e.replace(%2F%5C%2Famp%5C%2F%3F%24%2F%2C'')%3Bif((t!==f%7C%7Ce!==u)%26%26confirm('Update%20history%20and%20copy%20cleaned%20URL%20to%20clipboard%3F'))%7Bconst%20e=%60%24%7Blocation.protocol%7D%2F%2F%24%7Blocation.host%7D%24%7Bu%7D%24%7Bf%7D%24%7Blocation.hash%7D%60%3Bnavigator.clipboard.writeText(e)%2Chistory.replaceState(null%2C''%2Ce)%3Bconst%20t=window.open(e%2C'%5Fself'%2C'noreferrer')%3Bt%26%26(t.opener=null)%7D%7D)()%3Bvoid'2.2.0' "UtmStrip"
...
[Setup UtmStrip]: https://mobilemind.github.io/OpenInlets/x/#javascript:'use%20strict'%3B(()=%3E%7Bconst%20e=location.pathname%2Ct=location.search%3Bif(3%3Et.length%26%26!e.includes('%2Famp'))return%3Bconst%20r=location.hostname%2Co=new%20URLSearchParams(t)%2Ci=%5B'assetType'%2C'elqTrack'%2C'mkt%5Ftok'%2C'originalReferer'%2C'referrer'%2C'terminal%5Fid'%2C'trk'%2C'trkCampaign'%2C'trkInfo'%2C'anid'%2C'assetid'%2C'campaignid'%2C'eid'%2C'gclid'%2C'recipientid'%2C'siteid'%2C'fbclid'%2C'hrc'%2C'refsrc'%2C'gclsrc'%2C'%5Fhsenc'%2C'%5Fhsmi'%2C'mc%5Fcid'%2C'mc%5Feid'%2C'iesrc'%2C'cm%5Fmmc'%2C'cm%5Fre'%2C'cm%5Fsp'%2C'manual%5Fcm%5Fmmc'%5D%2Ca=%5B'fb%5F'%2C'action%5F'%2C'utm%5F'%2C'ga%5F'%2C'hmb%5F'%2C'pk%5F'%5D%2Cc=%5B'btsid'%2C'ws%5Fab%5Ftest'%2C'spm'%2C'scm'%2C'algo%5Fevid'%2C'algo%5Fpvid'%5D%2Cs=%5B'aff%5F'%5D%2Cn=%5B'%5Fencoding'%2C'ie'%2C'linkCode'%2C'linkId'%2C'pf'%2C'psc'%2C'ref%5F'%2C'tag'%2C'content-id'%2C'crid'%2C'cv%5Fct%5Fcx'%2C'language'%2C'qid'%2C'sprefix'%2C'sr'%2C'th'%2C'asc%5Fcampaign'%2C'asc%5Frefurl'%2C'asc%5Fsource'%2C'ascsubtag'%2C'dib'%2C'dib%5Ftag'%2C'pd%5Frd%5Fi'%2C'pd%5Frd%5Fr'%2C'pd%5Frd%5Fw'%2C'pd%5Frd%5Fwg'%2C'pf%5Frd%5Fi'%2C'pf%5Frd%5Fm'%2C'pf%5Frd%5Fp'%2C'pf%5Frd%5Fr'%2C'pf%5Frd%5Fs'%2C'pf%5Frd%5Ft'%5D%2C%5F=%5B'ac'%2C'annotation%5Fid'%2C'app'%2C'feature'%2C'gclid'%2C'kw'%2C'src%5Fvid'%5D%2Cd=r.includes('aliexpress.')%2Cm=%2F(%7C%5C.)amazon%5C.com%24%2F.test(r)%2Cp=%2F(m%7Cwww)%5C.youtube%5C.com%24%2F.test(r)%7C%7C'youtu.be'===r%7C%7C'www.youtube-nocookie.com'===r%2Cl=e=%3E%7Bconst%20t=e.toLowerCase()%3Bif(i.some(e=%3Ee.toLowerCase()===t))return!0%3Bif(a.some(e=%3Et.startsWith(e)))return!0%3Bif(%2F%5Ecm%5Fmmca%5Cd%2B%24%2Fi.test(e))return!0%3Bif(d)%7Bif(c.some(e=%3Ee.toLowerCase()===t))return!0%3Bif(s.some(e=%3Et.startsWith(e)))return!0%7Dreturn!(!m%7C%7C!n.some(e=%3Ee.toLowerCase()===t))%7C%7C!(!p%7C%7C!%5F.some(e=%3Ee.toLowerCase()===t))%7D%3Bfor(const%20e%20of%5B...o.keys()%5D)l(e)%26%26o.delete(e)%3Blet%20f=o.toString()%3Bf=f%3F'%3F'%2Bf:''%3Bconst%20u=e.replace(%2F%5C%2Famp%5C%2F%3F%24%2F%2C'')%3Bif((t!==f%7C%7Ce!==u)%26%26confirm('Update%20history%20and%20copy%20cleaned%20URL%20to%20clipboard%3F'))%7Bconst%20e=%60%24%7Blocation.protocol%7D%2F%2F%24%7Blocation.host%7D%24%7Bu%7D%24%7Bf%7D%24%7Blocation.hash%7D%60%3Bnavigator.clipboard.writeText(e)%2Chistory.replaceState(null%2C''%2Ce)%3Bconst%20t=window.open(e%2C'%5Fself'%2C'noreferrer')%3Bt%26%26(t.opener=null)%7D%7D)()%3Bvoid'2.2.0' "Setup UtmStrip"
