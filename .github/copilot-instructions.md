...
- **Lines of Code**: 21 TypeScript source files in `src/`, 6 Node.js scripts
  in `scripts/`
- **Node Version Required**: >=26.0.0 (strict requirement via
  `engineStrict: true`)
- **npm Version Required**: >=11.14.0
...
```text
npm warn EBADENGINE required: { node: '>=26.0.0', npm: '>=11.14.0' }
npm warn EBADENGINE current: { node: 'v24.0.0', npm: '10.8.2' }
```
