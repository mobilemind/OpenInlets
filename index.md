...
+ __[UtmStrip] v1.8.6__: Strips off the UTM query string elements of the
...
+ __[x-man] v1.1.9__: Using the selected text in browser, create a
...
+ __Mobile Safari setup link__ -- [Setup UtmStrip] v1.8.6
+ __Mobile Safari setup link__ -- [Setup x-man] v1.1.9
